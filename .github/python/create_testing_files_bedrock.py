...
def main():
    print("create_testing_files_bedrock.py: Script started")
    ...
    mctemplate_file_path = (
        mctemplate_file_root / f"{product_creator}_{product_key}_Bedrock_{ZIP_FILE_SUFFIX}"
    )
    print(
        f"create_testing_files_bedrock.py: Creating mctemplate file at {mctemplate_file_path.as_posix()}"
    )
    ...
    mcworld_file_path = (
        mcworld_file_root / f"{product_creator}_{product_key}_Bedrock_{ZIP_FILE_SUFFIX}"
    )
    print(
        f"create_testing_files_bedrock.py: Creating mcworld file at {mcworld_file_path.as_posix()}"
    )
    ...
    print("create_testing_files_bedrock.py: Finished with no errors!")
